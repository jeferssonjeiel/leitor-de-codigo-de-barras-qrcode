...
type
  TFormPrincipal = class(TForm)
    ...
    tabelaCODIGOS: TWideStringField;
    tabelaDATA: TWideStringField;
...
procedure TFormPrincipal.InserindoNoBanco;
  begin
    try
      ...
      tabela.Open();
      tabela.Insert;
      tabela.FieldByName('CODIGOS').AsString := ReadResult.text;
      tabela.FieldByName('DATA').AsString := FormatDateTime('dd/mm/yy - hh:nn:ss',Now);
